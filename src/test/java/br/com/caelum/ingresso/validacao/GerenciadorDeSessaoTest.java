...
public class GerenciadorDeSessaoTest {
	...
	public void preparaSessoes() {
		this.rogueOne = new Filme("Rogue One", Duration.ofMinutes(120), "SCIFI", BigDecimal.ONE);
	...
	@Test
	public void garanteQueNaoDevePermitirSessoesTermindandoDentroDoHorarioDeUmaSessaoJaExistente() {
		List<Sessao> sessoes = Arrays.asList(sessaoDasDez);
